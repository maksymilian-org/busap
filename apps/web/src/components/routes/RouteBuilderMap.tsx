...
import { BusapMap, RoutePolyline, NumberedStopMarker, FitBounds } from '@/components/map';
...
export default function RouteBuilderMap({ stops, positions, onClick }: RouteBuilderMapProps) {
  return (
